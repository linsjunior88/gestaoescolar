...
A API do Sistema de Gestão Escolar está rodando na porta 3000.
...
2. Endpoints principais:
   - Turmas: http://localhost:3000/api/turmas/
   - Disciplinas: http://localhost:3000/api/disciplinas/
   - Professores: http://localhost:3000/api/professores/
   - Alunos: http://localhost:3000/api/alunos/
   - Notas: http://localhost:3000/api/notas/

3. Buscando por ID específico:
   - Turma específica por ID numérico ou alfanumérico: http://localhost:3000/api/turmas/01AM
   - Turma específica pelo ID de turma: http://localhost:3000/api/turmas/id/01AM
   - Disciplina específica: http://localhost:3000/api/disciplinas/id/MAT
   - Aluno específico: http://localhost:3000/api/alunos/id/100922
